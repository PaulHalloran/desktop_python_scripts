cube = iris.load_cube(directory+'HadCM3'+'_sos_past1000_r1i1p1*_regridded_not_vertically.nc')
...
mltimodel_mean_cube_data = cube.data
...
for yr in years2:
    ...
    for i,model in enumerate(models2):
        cube = iris.load_cube(directory+model+'_sos_past1000_r1i1p1*_regridded_not_vertically.nc')
        try:
            iris.coord_categorisation.add_year(cube, 'time', name='year2')
        except:
            print 'year2 already exists'
    ...
    mltimodel_mean_cube_data[i,:,:] = meaned_year
