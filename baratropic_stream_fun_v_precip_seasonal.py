...
for model in models:
	...
	cube2 = iris.load_cube(directory+model+'_pr*.nc')
...
plt.title('Summer Precipitation Strong Subpolar Gyre')
...
bar = plt.colorbar(my_plot,ticks=[zmin, 0, zmax], orientation='horizontal', extend='both')
bar.set_label(all_data_high_mean_cube.long_name+' ('+format(all_data_high_mean_cube.units)+')')
plt.title('Summer Precipitation Weak Subpolar Gyre')
...
bar.set_label(all_data_high_mean_cube.long_name+' ('+format(all_data_high_mean_cube.units)+')')
plt.title('Summer High minus Low Subpolar Gyre')

#plt.show(block = True)
plt.savefig('/home/ph290/Documents/figures/spg_pr_1_summer.png')
...
bar = plt.colorbar(my_plot,ticks=[zmin, 0, zmax], orientation='horizontal', extend='both')
bar.set_label(all_data_high_mean_cube.long_name+' ('+format(all_data_high_mean_cube.units)+')')
plt.title('Summer Precipitation -6')
...
bar = plt.colorbar(my_plot,ticks=[zmin, 0, zmax], orientation='horizontal', extend='both')
bar.set_label(all_data_high_mean_cube.long_name+' ('+format(all_data_high_mean_cube.units)+')')
plt.title('Summer Precipitation -4')
...
bar = plt.colorbar(my_plot, orientation='horizontal', extend='both')
bar.set_label(all_data_high_mean_cube.long_name+' ('+format(all_data_high_mean_cube.units)+')')
plt.title('Summer Precipitation -2')
...
#plt.show(block = False)
plt.savefig('/home/ph290/Documents/figures/spg_pr_2_seasonal.png')
