		...
		for ensemble in ensembles:
			...
			for experiment in experiments:
				...
				for i,var in enumerate(variables):
					...
					tmp = glob.glob(dir2+model+'_sos_'+experiment+'*'+ensemble+'_regridded'+'*'+'.nc')
					...
					if np.size(tmp) == 0:
						...
						if not sizing == 0:
							...
							subprocess.call(['cdo -P 6 remapbil,r360x180 -selname,'+var+' '+temporary_file_space+temp_file3+' '+dir2+model+'_sos_'+experiment+'_'+ensemble+'_regridded_not_vertically.nc'], shell=True)
