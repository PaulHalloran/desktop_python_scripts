...
input_directory = '/data/temp/ph290/hist_nat/'
...
output_directory = '/data/temp/ph290/hist_nat/regridded/'
			...
			for i,var in enumerate(variables):
				...
				if np.size(tmp) == 0:
					...
					if not sizing == 0:
						...
						subprocess.call(['cdo -P 8 remapbil,r1440x720 -selname,'+var+' '+temporary_file_space+temp_file2+' '+dir2+model+'_'+variables[i]+'_'+experiment+'_'+ensemble+'_regridded_not_vertically.nc'], shell=True)
