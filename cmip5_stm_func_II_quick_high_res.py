...
for y in np.arange(180*4):
    flag = 0
    tmp = tmp_cube.data.mask[y,:]
    tmp2 = tmp_cube.data[y,:]
    for x in np.arange(360*4):
...
tmp_cube.data.data[150*4:180*4,:] = 0.0
tmp_cube.data.data[0:40*4,:] = 0.0
tmp_cube.data.data[:,20*4:180*4] = 0.0
tmp_cube.data.data[:,180*4:280*4] = 0.0
...
for file in files:
    ...
    thickness = np.flipud(np.rot90(np.tile(thickness,[180*4,1])))
...
plt.tight_layout()
#plt.show(block = False)
plt.savefig('/home/ph290/Documents/figures/amo_fig2_hr.png')
...
plt.tight_layout()
#plt.show(block = False)
#plt.savefig('/home/ph290/Documents/figures/amo_fig3_hr.png')
...
plt.tight_layout()
#plt.show(block = False)
plt.savefig('/home/ph290/Documents/figures/amo_fig4_hr.png')
...
plt.savefig('/home/ph290/Documents/figures/test1_hr.png')
#plt.show(block = False)
...
#plt.show(block=False)
plt.savefig('/home/ph290/Documents/figures/volc_tas_amo_hr.png')
...
#plt.show(block=False)
plt.savefig('/home/ph290/Documents/figures/volc_amoc_amo_hr.png')
...
#plt.show(block=False)
plt.savefig('/home/ph290/Documents/figures/solar_tas_amo_hr.png')
...
#plt.show(block=False)
plt.savefig('/home/ph290/Documents/figures/solar_amoc_amo_hr.png')
...
#plt.show(block=False)
plt.savefig('/home/ph290/Documents/figures/solar_tas_amob_hr.png')
...
#plt.show(block=False)
plt.savefig('/home/ph290/Documents/figures/volc_tas_amob_hr.png')
...
#plt.show(block=False)
plt.savefig('/home/ph290/Documents/figures/solar_str_amob_hr.png')
...
#plt.show(block=False)
plt.savefig('/home/ph290/Documents/figures/volc_str_amob_hr.png')
...
#plt.show(block = False)
plt.savefig('/home/ph290/Documents/figures/palaeoamo/pmip3_tas_and_stat_modelled_amo_hr.png')
