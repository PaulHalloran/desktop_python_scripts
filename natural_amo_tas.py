...
input_directory = '/media/usb_external1/cmip5/tas_regridded/'
input_directory2 = '/media/usb_external1/cmip5/reynolds_data/'

variables = np.array(['tas','tos'])
...
digital_cube_final.data[np.where(digital_low_cube.data <= -7)] = 1
digital_cube_final.data[np.where(digital_high_cube.data >= 7)] = 1
...
plt.gca().coastlines()
plt.title('surface temperature: low-high nat. amo >=4of6')
plt.show()
#plt.savefig('/home/ph290/Documents/figures/tas_amo_nat.pdf')
