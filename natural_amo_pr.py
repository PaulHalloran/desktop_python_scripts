...
cube1 = iris.load_cube(input_directory+models[0]+'*'+variable+'_'+experiment+'*.nc')[0]
...
plt.gca().coastlines()
plt.title('precip: low-high nat. amo >=xofy')
#plt.show()
plt.savefig('/home/ph290/Documents/figures/pr_amo_nat.pdf')
