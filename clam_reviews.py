...
x = 'decadal_moc_tos_correlation'
to_plot = mean_cubes(data,models,x)
lons = to_plot.coord('longitude').points
lats = to_plot.coord('latitude').points
ax1 = plt.subplot(311, projection = ccrs.PlateCarree())
ax1.set_extent((-90.0, 20.0, 10.0, 80.0), crs=ccrs.PlateCarree())
contour = plt.contourf(lons, lats, to_plot.data,levels=levels,cmap=brewer_cmap)
...
ax2.set_extent((-90.0, 20.0, 10.0, 80.0), crs=ccrs.PlateCarree())
contour = plt.contourf(lons, lats, to_plot.data,levels=levels,cmap=brewer_cmap)
cartopy.feature.LAND.scale='50m'
...
ax3.set_extent((-90.0, 20.0, 10.0, 80.0), crs=ccrs.PlateCarree())
contour = plt.contourf(lons, lats, to_plot.data,levels=levels,cmap=brewer_cmap)
cartopy.feature.LAND.scale='50m'
...
axColor = plt.axes([0.372,0.05,0.28,0.03])
#left bottom width height
plt.colorbar(contour, cax = axColor, orientation="horizontal",ticks=[-0.4,0,0.4])

plt.show()
#plt.savefig('/home/ph290/Documents/figures/clam_review_figure.png',dpi=500)
