...
input_directory = '/data/NAS-ph290/ph290/coursework/'
...
output_directory = '/data/NAS-ph290/ph290/coursework/mri/regrid/'
...
variables = np.array(['thetao','so','dissic'])
				...
				for i,var in enumerate(variables):
					...
					if np.size(tmp) == 0:
						...
						if not sizing == 0:
							...
							#print 'exract just the surface level'
							#subprocess.call(['cdo sellevidx,1 '+temporary_file_space+temp_file1+' '+temporary_file_space+temp_file2], shell=True) 
							...
							subprocess.call(['cdo -P 8 remapbil,r360x180 -selname,'+var+' '+temporary_file_space+temp_file2+' '+dir2+model+'_'+variables[i]+'_'+experiment+'_'+ensemble+'_regridded_not_vertically.nc'], shell=True)
