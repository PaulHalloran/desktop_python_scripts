cube = iris.load_cube(directory+'HadCM3'+'_pr_past1000_r1i1p1*_regridded.nc')
...
mltimodel_mean_cube_data_pr = cube.data
...
for yr in years2:
    ...
    for i,model in enumerate(models2):
        cube = iris.load_cube(directory+model+'_pr_past1000_r1i1p1_regridded.nc')
        try:
            iris.coord_categorisation.add_year(cube, 'time', name='year2')
        except:
            print 'year2 already exists'
    ...
    mltimodel_mean_cube_data_pr[i,:,:] = meaned_year
