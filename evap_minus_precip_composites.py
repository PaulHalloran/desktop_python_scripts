...
#MIGHT BE WORTH REMOVING THE SHORT TERM VARIABILITY AS WELL??
...
for j,offset in enumerate(offsets):
	...
	plt.gca().coastlines()
	plt.title('PMIP3 high evaporation yr '+corr_variable+' composites, n = '+str(i))
	plt.savefig('/home/ph290/Documents/figures/evaporation_minus_precip_composites_'+names[j]+'_2.png')
	#plt.show()
