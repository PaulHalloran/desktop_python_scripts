...
digital_data_tmp1 = high_low.copy()
digital_data_tmp2 = high_low.copy()
...
plt.gca().coastlines()
plt.title('Shortwave: sstClimAero - sstClim '+np.str(no_agree)+'of3')
plt.savefig('/home/ph290/Documents/figures/sw_sstclim_sstclimaero.pdf')
plt.show()
