			...
			for i,var in enumerate(variables):
				...
				if np.size(tmp) == 0:
					...
					if not sizing == 0:
						...
						subprocess.call('cdo -P 8  yearmean '+temporary_file_space+temp_file2+' '+temporary_file_space+temp_file3, shell=True)
						...
						subprocess.call(['cdo -P 8 remapbil,r360x180 -selname,'+var+' '+temporary_file_space+temp_file3+' '+dir2+model+'_'+variables[i]+'_'+experiment+'_'+ensemble+'_regridded_not_vertically.nc'], shell=True)
