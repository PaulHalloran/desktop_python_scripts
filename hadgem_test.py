...
d  = iris.load('/home/ph290/hadgem2/ajnuh/*.pp')[2]
...
a1 = m2a(iris.load_cube('/home/ph290/data0/hadgem2es/rsds_Amon_HadGEM2-ES_historical_r1i1p1.nc'))
b1 = m2a(iris.load_cube('/home/ph290/data0/hadgem2es/rsds_Amon_HadGEM2-ES_historical_r2i1p1.nc'))
c1 = m2a(iris.load_cube('/home/ph290/data0/hadgem2es/rsds_Amon_HadGEM2-ES_historical_r3i1p1.nc'))
d1 = m2a(iris.load_cube('/home/ph290/data0/hadgem2es/rsds_Amon_HadGEM2-ES_historical_r4i1p1.nc'))
e1 = m2a(iris.load_cube('/home/ph290/data0/hadgem2es/rsds_Amon_HadGEM2-ES_historical_r5i1p1.nc'))
...
plt.close('all')
qplt.contourf((low_amo1-high_amo1)-(low_amo-high_amo),np.linspace(-12,12,31))
plt.gca().coastlines()
plt.title('sw')
plt.savefig('/home/ph290/Documents/figures/hadgem.png')
