...
plt.title('Precipitation Strong Subpolar Gyre')
...
bar = plt.colorbar(my_plot,ticks=[zmin, 0, zmax], orientation='horizontal', extend='both')
bar.set_label(all_data_high_mean_cube.long_name+' ('+format(all_data_high_mean_cube.units)+')')
plt.title('Precipitation Weak Subpolar Gyre')
...
#plt.show(block = True)
plt.savefig('/home/ph290/Documents/figures/spg_pr_1.png')
...
#plt.show(block = False)
plt.savefig('/home/ph290/Documents/figures/spg_pr_2.png')
