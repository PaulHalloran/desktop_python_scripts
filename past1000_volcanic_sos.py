...
cube_initial = iris.load_cube(input_directory+models[0]+'*'+variables[0]+'*.nc')
...
bar.set_label(cube_mca.long_name+' ('+format(cube_mca.units)+')')

#plt.show(block = False)
plt.savefig('/home/ph290/Documents/figures/mca_sos.png')
...
#plt.show(block = False)
plt.savefig('/home/ph290/Documents/figures/lia_sos.png')
