...
input_directory = '/home/ph290/data0/cmip5_data/msftmyz/piControl/'
...
output_directory = '/media/usb_external1/cmip5/msftmyz/piControl/'
	...
	for experiment in experiments:
		...
		for i,var in enumerate(variables):
			...
			if np.size(tmp) == 0:
				...
				files = glob.glob(dir1+'/'+var+'*'+time_period+'*_'+model+'_*'+experiment+'_*r1*.nc')
				...
				if not sizing == 0:
					...
					subprocess.call('cdo yearmean '+temporary_file_space+temp_file1+' '+temporary_file_space+temp_file4, shell=True)
					subprocess.call('rm '+temporary_file_space+temp_file3, shell=True)
