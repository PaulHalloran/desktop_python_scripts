...
input_directory = '/data/temp/ph290/pi_psl/'
...
output_directory = '/media/usb_external1/cmip5/piControl_summer/'
output_directory2 = '/media/usb_external1/cmip5/piControl_winter/'
			...
			for i,var in enumerate(variables):
				...
				if np.size(tmp) == 0:
					...
					if not sizing == 0:
						...
						print 'merging months to seasons'
						subprocess.call('cdo -P 6 seasmean '+temporary_file_space+temp_file1+' '+temporary_file_space+temp_file2, shell=True)
						subprocess.call('rm '+temporary_file_space+temp_file1, shell=True)
						print 'extrating JJA'
						subprocess.call('cdo -P 6 selseas,JJA '+temporary_file_space+temp_file2+' '+temporary_file_space+temp_file3, shell=True)
						subprocess.call('cdo -P 6 selseas,DJF '+temporary_file_space+temp_file2+' '+temporary_file_space+temp_file3b, shell=True)
						...
						subprocess.call(['cdo -P 6 remapbil,r360x180 -selname,'+var+' '+temporary_file_space+temp_file3+' '+dir2+model+'_'+variables[i]+'_'+experiment+'_'+ensemble+'_regridded.nc'], shell=True)
						subprocess.call('rm '+temporary_file_space+temp_file3, shell=True)
						subprocess.call(['cdo -P 6 remapbil,r360x180 -selname,'+var+' '+temporary_file_space+temp_file3b+' '+output_directory2+model+'_'+variables[i]+'_'+experiment+'_'+ensemble+'_regridded.nc'], shell=True)
						...
						subprocess.call('rm '+temporary_file_space+temp_file3b, shell=True)
					else:
